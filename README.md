...
This guide is just the beginning. The best way to learn is by doing. Explore the file system, try out the commands, write a script, create some art, and build an adventure. OopisOS is your oyster.
